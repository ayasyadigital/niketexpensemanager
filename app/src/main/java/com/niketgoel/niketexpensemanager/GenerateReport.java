...
import com.niketgoel.niketexpensemanager.helpers.CustomDatePickerDialog;
	...
	private class ExportPDF extends Export {
		...
		// add metadata to the PDF which can be viewed in your Adobe Reader
	 	...
	 	private void addMetaData(Document document) {
	 		document.addTitle("Expenses Report using Expense Tracker (NiketGoel)");
	 		document.addSubject("PDF created using android app \"Expense Tracker (NiketGoel)\"");
	 		document.addKeywords("Android, PDF, NiketGoel, Expense, Tracker, Expense Tracker");
	 		document.addAuthor("NiketGoel");
	 		document.addCreator("NiketGoel");
	 	}
		...
		private void addEmptyLine(Paragraph paragraph, int number) {
	 	...
	 	public class HeaderAndFooter extends PdfPageEventHelper {
	 		...
	 		public HeaderAndFooter() {
	 			...
	 			Chunk chunk = new Chunk("Report Generated Using - Expense Tracker (NiketGoel)");
